...
<div style="display: flex; align-items: flex-start; margin: 2em 0;">
  <video src="index_files/travolta.mp4" autoplay loop muted playsinline style="width:220px; max-width:40vw; height:auto; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,0.08); margin-right:1.5em; float:left;">
    Your browser does not support the video tag.
  </video>
  <div style="flex:1;">
    <p>Some quantum computing companies more than others seem to enjoy to extend the quantum realm to their public relations.Like the famous Schrödinger's cat, the landscape is a bit like a superposition of states, promising to deliver the next big milestone, but in perpetual delay, an ever-receding horizon, a mirage.</p>
    <p>I looked at what the three most well known publicly listed quantum computing startups have promised and achieved over the years. 
    <p>Here is what Rigetti Computing, D-Wave and IonQ said and did over the years.</p>
  </div>
</div>

## Promises vs Achievements

| Company           | Promise Date | Promise| Achieved | Achievement Date | Notes | References |
|-------------------|----------------|--------------------|-----------|---------------|----------------|-----------|
...
| Rigetti Computing |                |  |  | 2020 | At last, deployed the 32-qubit Aspen-8 system on Amazon Braket. T2* ~ 20µs. 1-qubit and 2-qubit gate times: 60ns and 160ns. 2-qubit fidelity range: 95%-99%. Introduced active qubit reset. | [Achievement](https://medium.com/rigetti/rigetti-aspen-8-on-aws-236d9dc11613), [Achievement](https://qa.qcs.rigetti.com/qpus) |
| Rigetti Computing | 2021           | Scale quantum computers to 1,000 (2024) and 4,000 (2026). | No |  | SPAC announcement. 💉🗑️ | [Promise](https://investors.rigetti.com/news-releases/news-release-details/rigetti-computing-global-leader-full-stack-quantum-computing) |
| Rigetti Computing | 2022           | Change of mind, 1,000 (2025) and 4,000 (2027).| No |  | Apparently one more year sounded more reasonable! 😅 | [Promise](https://siliconangle.com/2022/05/16/rigettis-quantum-computing-roadmap-gets-pushed-back-amid-supply-crunch-higher-costs/) |
...
| Rigetti Computing |                |  |  | Dec 2024 | Ankaa-3 system, 84 qubits, 2Q gate fidelity median ~99.5%. | [Achievement](https://investors.rigetti.com/news-releases/news-release-details/rigetti-computing-launches-84-qubit-ankaatm-3-system-achieves) |
| Rigetti Computing | Dec 2024       | Introduce next-gen modular system in 2025; by mid-2025, release 36-qubit system (4x9 chips, 2x error reduction); by end-2025, release >100-qubit system (2x error reduction). | No |  |  | [Promise](https://investors.rigetti.com/news-releases/news-release-details/rigetti-computing-launches-84-qubit-ankaatm-3-system-achieves) |

## A Quantumcazzola

I would like to take a moment to reflect on this phenomenon aided by an italian literary device known as [Supercazzola](https://it.wikipedia.org/wiki/Supercazzola) or, in this case, a Quantumcazzola. In style it departs quite a bit, but the core character is there. In its absurdity, it is surprisingly more meaningful than the PR statements we reviewed above.

Who knew that LLMs could be so adept at making words up?! Thanks Gemini!
